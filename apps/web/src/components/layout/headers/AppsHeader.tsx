      ...
      <div className="w-full px-3 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between gap-4 sm:gap-6">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 select-none shrink-0 whitespace-nowrap">
          {activeSubTitle ? (
            <button
              onClick={onBack}
              className="group text-base sm:text-lg lg:text-xl font-black text-[#F15A24] dark:text-orange-400 uppercase tracking-tight cursor-pointer flex items-center hover:text-orange-600 dark:hover:text-orange-300 transition-colors select-none shrink-0 py-1"
            ...
            >
              <span className="inline-flex items-center overflow-hidden transition-all duration-200 ease-out w-0 opacity-0 -translate-x-1 group-hover:w-5 group-hover:opacity-100 group-hover:translate-x-0 group-hover:mr-1 group-active:w-5 group-active:opacity-100 group-active:translate-x-0 group-active:mr-1 group-focus-visible:w-5 group-focus-visible:opacity-100 group-focus-visible:translate-x-0 group-focus-visible:mr-1 shrink-0">
                <ChevronLeft className="w-5 h-5 stroke-[3] text-[#F15A24] dark:text-orange-400 shrink-0" />
              </span>
