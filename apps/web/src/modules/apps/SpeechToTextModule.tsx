            ...
            <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm p-3 sm:p-4 flex-1 min-h-0 flex flex-col justify-between overflow-hidden relative transition-all">
              ...
              <div className="flex flex-col gap-2 mb-2 flex-shrink-0 relative z-10">
                ...
                <div className="px-3.5 py-2 sm:px-4 sm:py-2 rounded-xl bg-gradient-to-r from-sky-50/90 via-sky-50/40 to-blue-50/60 dark:from-slate-800 dark:via-slate-800/80 dark:to-slate-850 border border-sky-200/70 dark:border-slate-700/80 shadow-2xs flex items-center justify-between gap-2 flex-wrap sm:flex-nowrap">
                  {/* Góc Trái: Tiêu đề Hộp Thoại - Căn thẳng hàng hoàn hảo với hiệu ứng Xuất hiện, Shimmer & Pulse Glow */}
                  <div key={currentConversationId} className="flex items-center gap-2.5 shrink-0 h-8.5 relative overflow-hidden pr-1.5">
                    {/* Vệt sáng quét ngang khi xuất hiện */}
                    <div className="absolute inset-0 w-1/3 bg-gradient-to-r from-transparent via-sky-300/40 dark:via-sky-400/25 to-transparent pointer-events-none animate-header-sweep" />

                    <div className="w-7 h-7 rounded-lg bg-[#00A8E8]/10 dark:bg-[#00A8E8]/20 flex items-center justify-center border border-[#00A8E8]/30 shrink-0 shadow-2xs animate-icon-appear transition-all">
                      <MessageSquare className="w-4 h-4 text-[#00A8E8] dark:text-[#38BDF8] stroke-[2.5]" />
                    </div>
                    <h2 className="text-sm sm:text-base font-black uppercase tracking-wider flex items-center gap-2 shrink-0 leading-none animate-text-appear">
