        ...
        <div className="w-full h-full flex-1 min-h-0 overflow-hidden px-3 sm:px-6 lg:px-8 py-3 relative z-10 flex flex-col justify-between">
          ...
          <div className="flex-1 min-h-0 overflow-hidden">
            <div className="h-full grid grid-cols-1 lg:grid-cols-12 gap-3 overflow-hidden">
              ...
              {/* ========================================================================= */}
              <div className="hidden lg:flex lg:col-span-4 xl:col-span-3 flex-col h-full overflow-hidden text-xs shrink-0">
              ...
              {/* ========================================================================= */}
              <div className="lg:col-span-8 xl:col-span-9 flex flex-col justify-between space-y-3 h-full overflow-hidden">
