...
export const ClusterKModule: React.FC<ClusterKModuleProps> = ({
  ...
  // Đồng bộ tab hiện tại, mặc định là 'kien' nếu tab rỗng hoặc không thuộc danh sách
  const currentKey = ['kien', 'hash', 'k2t', 'k2b', 'k1'].includes(activeTab) ? activeTab : 'kien';
  ...
  return (
    <div className="w-full h-full flex-1 min-h-0 overflow-y-auto bg-slate-50/60 dark:bg-slate-950 text-[#1F2937] dark:text-slate-100 p-3 sm:p-5 space-y-4">
      ...
      {/* ========================================================================= */}
      {/* 📦 BỘ 5 HỘP ĐỘC LẬP PHÂN HỆ CỤM #K (CHUẨN SKY GLASSMORPHISM 26PX ĐỒNG BỘ) */}
      {/* ========================================================================= */}
      <div className="space-y-2">
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-[#0284C7] animate-pulse" />
            <h2 className="text-xs sm:text-sm font-black text-slate-800 dark:text-slate-200 uppercase tracking-tight">
              5 HỘP ĐỘC LẬP PHÂN HỆ CỤM #K
            </h2>
          </div>
          <span className="text-[11px] font-semibold text-slate-400 dark:text-slate-500 hidden sm:inline">
            Nhấp vào từng hộp để kích hoạt không gian giao diện nghiệp vụ độc lập
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 sm:gap-3.5 w-full">
          {BOXES_CONFIG.map((box) => {
            ...
            return (
              ...
              >
                {/* Hairline top glow on hover & active */}
      ...
      {/* ========================================================================= */}
      {/* 🚀 BANNER ĐỊNH DANH GIAO DIỆN ĐỘC LẬP CHO HỘP ĐANG CHỌN */}
      {/* ========================================================================= */}
      ...
      {/* ========================================================================= */}
      {/* 💠 1. GIAO DIỆN ĐỘC LẬP: HỘP KIẾN (Chủ Trương & Duyệt Ngân Sách) */}
      {/* ========================================================================= */}
      {currentKey === 'kien' && (
        <div className="space-y-4 animate-fade-in">
          {/* 3 Thẻ Chỉ Số KPI Độc Lập Cho Kiến */}
          ...
          {/* Không Gian Tác Nghiệp Độc Lập Cho Kiến */}
      ...
      {/* ========================================================================= */}
      {/* 🔬 2. GIAO DIỆN ĐỘC LẬP: HỘP # (Khảo Sát Kỹ Thuật & Đo Đạc QA/QC) */}
      {/* ========================================================================= */}
      {currentKey === 'hash' && (
        <div className="space-y-4 animate-fade-in">
          {/* 3 Thẻ Chỉ Số KPI Độc Lập Cho # */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 shadow-2xs">
          ...
          {/* Không Gian Tác Nghiệp Độc Lập Cho # */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-4 shadow-2xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/80 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <button
      ...
      {/* ========================================================================= */}
      {/* 💻 3. GIAO DIỆN ĐỘC LẬP: HỘP #K2T (Kỹ Thuật R&D & Thực Nghiệm Vi Mạch) */}
      {/* ========================================================================= */}
      {currentKey === 'k2t' && (
        <div className="space-y-4 animate-fade-in">
          {/* 3 Thẻ Chỉ Số KPI Độc Lập Cho #K2T */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 shadow-2xs">
          ...
          {/* Không Gian Tác Nghiệp Độc Lập Cho #K2T */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-4 shadow-2xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/80 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <button
      ...
      {/* ========================================================================= */}
      {/* 📦 4. GIAO DIỆN ĐỘC LẬP: HỘP #K2B (Điều Hành Tác Nghiệp Dự Án & SLA) */}
      {/* ========================================================================= */}
      {currentKey === 'k2b' && (
        <div className="space-y-4 animate-fade-in">
          {/* 3 Thẻ Chỉ Số KPI Độc Lập Cho #K2B */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 shadow-2xs">
          ...
          {/* Không Gian Tác Nghiệp Độc Lập Cho #K2B */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-4 shadow-2xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/80 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <button
      ...
      {/* ========================================================================= */}
      {/* 🔰 5. GIAO DIỆN ĐỘC LẬP: HỘP #K1 (Cố Vấn & Kiểm Chuẩn Công Nghệ) */}
      {/* ========================================================================= */}
      {currentKey === 'k1' && (
        <div className="space-y-4 animate-fade-in">
          {/* 3 Thẻ Chỉ Số KPI Độc Lập Cho #K1 */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 shadow-2xs">
          ...
          {/* Không Gian Tác Nghiệp Độc Lập Cho #K1 */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-4 shadow-2xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/80 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <button
